...
export const getNetwork = (state: RootState) =>
  state.account.current.getNetwork(state.settings.network);
export const getStakeAddress = (state: RootState) =>
  state.account.current.getNetwork(state.settings.network).stakeAddress;
export const getAddresses = (state: RootState) =>
  state.account.current.getNetwork(state.settings.network).addresses;
export const getAssets = (state: RootState) =>
  state.account.current.getNetwork(state.settings.network).assets;
export const getTransactions = (state: RootState) =>
  state.account.current.getNetwork(state.settings.network).transactions;
