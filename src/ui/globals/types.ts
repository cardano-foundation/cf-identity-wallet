...
enum OperationType {
  ...
  NEW_CRYPTO_ACCOUNT = "newCryptoAccount",
  RESTORE_CRYPTO_ACCOUNT = "restoreCryptoAccount",
  ...
  RESTORE_CREDENTIAL = "restoreCredential",
  DELETE_CREDENTIAL = "deleteCredential",
  SCAN_CONNECTION = "scanConnection",
  CREATE_SEED_PHRASE = "onboardingcreate",
  RESTORE_SEED_PHRASE = "onboardingrestore",
}
