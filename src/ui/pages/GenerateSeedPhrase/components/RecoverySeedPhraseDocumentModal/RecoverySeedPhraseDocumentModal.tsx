    ...
    >
      <ScrollablePageLayout
        ...
        header={
          <PageHeader
            closeButton={true}
            closeButtonLabel={`${i18n.t("generateseedphrase.onboarding.recoveryseedphrasedocs.button.done")}`}
            closeButtonAction={() => setIsOpen(false)}
            title={`${i18n.t("generateseedphrase.onboarding.recoveryseedphrasedocs.title")}`}
          />
        }
      >
        <InfoCard danger content={i18n.t("generateseedphrase.onboarding.recoveryseedphrasedocs.alert")}/>
        <DocumentSection sectionKey="what" image={Image}/>
