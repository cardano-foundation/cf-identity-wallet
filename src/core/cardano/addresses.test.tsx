...
const VALID_SEEDPHRASE_15_WORDS = "test walk nut penalty hip pave soap entry language right filter choice";
...
const VALID_SEEDPHRASE_24_WORDS = "find bag dilemma sing symptom page sand exotic celery tape cat typical sea portion jar return trophy warfare tribe soap protect tuna goddess shine";
