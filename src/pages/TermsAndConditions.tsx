            ...
            <IonCol
              ...
              <IonItem>
                <IonLabel className="disclaimer-text">
                  ...
                  downloaded by You on any electronic device, named Identity
                  Wallet
                  <br />
                  <br />
                  ...
                  "Our" in this Agreement) refers to Cardano Foundation, Zurich,
                  Switzerland.
                  <br />
                  <br />
                  ...
                  Terms and Conditions agreement has been created with the help
                  ...
                  <br />
                  <br />
                  "AS IS" and "AS AVAILABLE" Disclaimer The Service is provided
                  to You "AS IS" and "AS AVAILABLE" and with all faults and
                  ...
                  <a href="mailto:legal@cardanofoundation.org">
                    legal@cardanofoundation.org
                  </a>
                </IonLabel>
              </IonItem>
            </IonCol>
