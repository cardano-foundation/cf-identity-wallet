...
interface DidPaperProps {
}

/**
 * Primary UI component for user interaction
 */
export const DidPaper = ({...props}: DidPaperProps) => {
  return (
      <>
                ...
                <div className="flex-none sm:flex">
                  ...
                  <div className="flex-auto justify-evenly">
                    ...
                    <div className="border-b border-dashed border-b-2 my-5 pt-5">
                      <div
                          className={`absolute rounded-full w-5 h-5 -mt-2 -left-2 bg-${document.body.classList.contains('dark') ? 'black' : 'white'}`}/>
                      <div
                          className={`absolute rounded-full w-5 h-5 -mt-2 -right-2 bg-${document.body.classList.contains('dark') ? 'black' : 'white'}`}/>
                    </div>
