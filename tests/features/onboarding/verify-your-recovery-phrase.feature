Feature: VerifyYourRecoveryPhrase
  ...
  Scenario: VerifyYourRecoveryPhrase - user can go back to Your Recovery Phrase screen
  ...
  Scenario: VerifyYourRecoveryPhrase - user can verify words of recovery phrase
    Given user continue after choose and save words of recovery phrase
