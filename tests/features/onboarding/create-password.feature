Feature: CreatePassword
  ...
  Scenario Outline: CreatePassword - validation for <name>
    ...
    Examples:
      ...
      | too long password             | 1234567asdwer@#$3FSvcvxzvxvfas4af4afavbns2adfasfs4wfsagsfssfewfa2 | Must contain between 8-64 characters |
      | too short password            | 1234567                                                           | Must contain between 8-64 characters |
